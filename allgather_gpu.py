# this script is for gpu tensor all_gather test using nccl backend
# 2 nodes: torchrun --nnodes=2 --nproc_per_node=1 --rdzv_id=job_1234 --rdzv_backend=c10d --rdzv_endpoint=fdbd:dc61:20:11::16:12345 ./allgather_gpu.py
...
def test_all_gather():
    ...
    # Create a tensor specific to each rank and move it to GPU
